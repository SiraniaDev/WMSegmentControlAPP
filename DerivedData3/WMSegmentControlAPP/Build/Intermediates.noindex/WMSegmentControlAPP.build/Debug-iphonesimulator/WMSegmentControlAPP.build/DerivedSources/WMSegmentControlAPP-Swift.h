...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WMSegmentControlAPP",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC19WMSegmentControlAPP11AppDelegate")
...
SWIFT_CLASS("_TtC19WMSegmentControlAPP13SceneDelegate")
...
SWIFT_CLASS("_TtC19WMSegmentControlAPP14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, strong) IBOutlet BetterSegmentedControl * _Null_unspecified control3;
- (void)viewDidLoad;
- (void)navigationSegmentedControlValueChanged:(BetterSegmentedControl * _Nonnull)sender;
